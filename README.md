...
This repository contains a backtester [IMC Prosperity 4](https://prosperity.imc.com/) algorithms, refactored version of [@jmerle](https://github.com/jmerle) [backtester for Prosperity 3](https://github.com/jmerle/imc-prosperity-3-backtester). The output it generates closely matches the format of the output generated by the official submission environment.
